...
```bash
git remote add encore encore://auto-reporting-dashboard-rdoi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/auto-reporting-dashboard-rdoi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/auto-reporting-dashboard-rdoi/settings/integrations/github)
